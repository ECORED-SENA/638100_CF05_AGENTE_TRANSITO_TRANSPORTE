  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Promoviendo la formación en seguridad vial
        p.mb-4 Afianzar los conceptos y saberes sobre educación y capacitación para aplicación de normas de seguridad vial, con base en las temáticas del componente formativo.
