        ...
        AcordionA.mb-5(tipo="b" clase-tarjeta="tarjeta tarjeta--amarilla")
          .row(titulo="Modelo tradicional")
            .col-md-8.mb-4.mb-md-0
              p Este modelo pedagógico también es conocido como el modelo externalista o escuela pasiva, centra el aprendizaje en el individuo de manera pasiva, es decir, fuentes externas generan el conocimiento del ser, por ejemplo, los maestros, los padres, el medio, entre otros. 
                br
                br
          ...
          .row(titulo="Modelo romántico")
            .col-md-8.mb-4.mb-md-0
              p Se proponen varios factores para el aprendizaje (maestro, estudiante y entorno pedagógico), el entorno y/o ambiente pedagógico adecuado, sencillo y flexible, el estudiante como individuo libre de denotar y experimentar las habilidades o talentos y el maestro como aquel sujeto dinamizador del proceso. 
                br
                br
          ...
          .row(titulo="Modelo progresista")
            .col-md-8.mb-4.mb-md-0
              p Obtiene sus principios bajo ideas filosóficas encaminadas al pragmatismo, uno de los teóricos de este modelo es Rodríguez, S. quien expone que el progresismo pedagógico es el aseguramiento de la sociedad respecto a su propio desarrollo.
                br
                br
          ...
          .row(titulo="Modelo constructivista")
            .col-md-8.mb-4.mb-md-0
              p Bajo este modelo pedagógico se utilizan elementos que ayudan al estudiante a construir la respuesta a los problemas planteados por el docente y la sociedad, con el fin de que una vez finalizado el proceso se cree el aprendizaje. 
                br
                br
          ...
          .row(titulo="Modelo cognitivo - social ")
            .col-md-8.mb-4.mb-md-0
              p Modelo propuesto principalmente por psicólogos entre ellos Gagné, quienes centraron el aprendizaje en un compendio multifacético de capacidades, las cuales se ven influidas por la sociedad, la colectividad y los entornos.
                br
                br
